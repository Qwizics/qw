...
function AnswerResultListTable(props) {
  const [
    recordIdToDestroy,
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.answerResult.fields.answer',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.answerResult.fields.question',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.answerResult.fields.user',
                )}
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <ExamAnswerListItem value={row.answer} />
                </TableCell>
                <TableCell>
                  <ExamQuestionListItem value={row.question} />
                </TableCell>
                <TableCell>
...
export default AnswerResultListTable;
