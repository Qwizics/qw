...
function AnswerResultToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    answerResultSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    answerResultSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=answerResult"
...
export default AnswerResultToolbar;
