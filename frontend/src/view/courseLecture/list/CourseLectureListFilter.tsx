...
const schema = yup.object().shape({
  lectureTitle: yupFilterSchemas.string(
    i18n('entities.courseLecture.fields.lectureTitle'),
  ),
  lectureType: yupFilterSchemas.string(
    i18n('entities.courseLecture.fields.lectureType'),
  ),
  lectureUrl: yupFilterSchemas.string(
...
function CourseLectureListFilter(props) {
...
export default CourseLectureListFilter;