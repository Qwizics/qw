...
function CourseRegistrationListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    courseRegistrationSelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.courseRegistration.fields.attendee',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.courseRegistration.fields.course',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <UserListItem value={row.attendee} />
                </TableCell>
                <TableCell>
                      ...
                      {hasPermissionToEdit && (
                        ...
                        >
                          <IconButton
                            color="primary"
                            component={Link}
                            to={`/course-registration/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
...
export default CourseRegistrationListTable;
