...
require('./courseRegistration').default(routes);
require('./exam').default(routes);
require('./courseLecture').default(routes);
require('./coursePayment').default(routes);
require('./examQuestion').default(routes);
